        ...
        <div className="space-y-6">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                {doctors.map((doc) => (
                    {
                        doctors.map((doc) => (
                            <div key={doc.id} className="bg-[#0f1014]/60 backdrop-blur-md p-6 rounded-xl border border-white/10 relative overflow-hidden group hover:bg-[#0f1014]/80 transition-all duration-300">
                                {/* Hover Gradient Glow */}
                                ...
                                <div className="flex items-start justify-between mb-4 relative z-10">
                                    ...
                                    <span className={`px-3 py-1 rounded-full text-xs font-bold border ${doc.currentWorkload >= doc.maxLoad
